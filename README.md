# wallpapers
 ...
 Link truy cập website: http://anhtuan-it.epizy.com/ <br>
 ...
 -> Client: xem và download hình ảnh, tìm kiếm hình ảnh theo thể loại, xem dữ liệu hình ảnh ở dạng Json (http://anhtuan-it.epizy.com/api/types) <br>
